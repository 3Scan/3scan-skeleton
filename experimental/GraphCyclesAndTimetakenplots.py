...
from skeleton.metrics.segmentStats import getSegmentStats

"""
   This program checks the time taken to detect branches in a tree and length of branches to each node
