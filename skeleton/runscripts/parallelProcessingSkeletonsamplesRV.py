...
def convert(tupValList):
    ...
    for i, j, k in tupValList:
        ...
        f = open("/home/pranathi/awesomeResults/subsubVolumestats/stats_{}_{}_{}.txt".format(i + 160, j, k), 'w')
        f.writelines(d)
        f.close()
        np.save("/home/pranathi/awesomeResults/subsubVolumeskeletons/skeleton_{}_{}_{}.npy".format(i + 160, j, k), skeleton)
        np.save("/home/pranathi/awesomeResults/subsubVolumethresholds/threshold_{}_{}_{}.npy".format(i + 160, j, k), interpolatedIm)
...
if __name__ == '__main__':
    ...
    klist = [k for k in range(67, 8026 - 68, iskpx) if k < 1500 or (k > 2300 and k < 4000) or (k > 5500 and k < 8000)]
